(function () {
    ...
    ***************************************************************************** */
    ...
    (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { vertices: cubeVertices, normal: cubeNormal, indices: cubeIndices, } = index.createBox();
        ...
        const { vertices: sphereVertices, normal: sphereNormal, indices: sphereIndices, } = index.createSphere({
            widthSegments: 30,
            heightSegments: 30,
        });
        ...
        const { vertices: torusVertices, normal: torusNormal, indices: torusIndices, } = index.createTorus({
            radialSegments: 25,
            tubularSegments: 25,
        });
        ...
        function drawFrame(ts) {
            ...
            device.queue.writeBuffer(cubeTransformUniformBuffer, 0, cubePositionTransform.modelMatrix);
            ...
            device.queue.writeBuffer(sphereTransformUniformBuffer, 0, spherePositionTransform.modelMatrix);
            renderPass.setVertexBuffer(0, sphereVertexBuffer);
            renderPass.setVertexBuffer(1, sphereNormalBuffer);
            renderPass.setIndexBuffer(sphereIndexBuffer, sphereIndices instanceof Uint16Array ? 'uint16' : 'uint32');
            ...
            device.queue.writeBuffer(torusTransformUniformBuffer, 0, torusPositionTransform.modelMatrix);
            renderPass.setVertexBuffer(0, torusVertexBuffer);
            renderPass.setVertexBuffer(1, torusNormalBuffer);
            renderPass.setIndexBuffer(torusIndexBuffer, torusIndices instanceof Uint16Array ? 'uint16' : 'uint32');
