...
${String.fromCharCode(dataView.getUint8(byteOffset + 3))}`;
    ...
    ***************************************************************************** */
    ...
    class RenderNode extends Node {
        constructor(device, geometry, vertexShaderSource, fragmentShaderSource, presentationFormat = 'bgra8unorm', primitiveType = 'triangle-list') {
            super();
            this.device = device;
            this.pipeline = device.createRenderPipeline({
                vertex: {
                    ...
                    entryPoint: 'main',
                    buffers: geometry
                        .filter(({ typedArray }) => !(typedArray instanceof Uint16Array ||
        ...
        render(renderPass, camera) {
            ...
            this.buffers.forEach(({ typedArray, buffer }, i) => {
                ...
                typedArray instanceof Uint16Array ||
                    // @ts-ignore
                    typedArray instanceof Uint32Array) {
                    renderPass.setIndexBuffer(buffer, 
                    // @ts-ignore
            ...
            this.device.queue.writeBuffer(this.commonUniformBlockBuffer, 0, camera.projectionMatrix);
            this.device.queue.writeBuffer(this.commonUniformBlockBuffer, 16 * Float32Array.BYTES_PER_ELEMENT, camera.viewMatrix);
    ...
    (() => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const gltf = yield load('/webgpu-dojo/dist/assets/Duck.gltf', GLTFLoader);
        ...
        function traverseSceneGraph(currentNode, parentNode = null) {
            ...
            if (currentNode.mesh) {
                ...
                sceneNode = new RenderNode(device, geometry, VERTEX_SHADER, FRAGMENT_SHADER);
            }
            else {
                sceneNode = new Node();
            }
